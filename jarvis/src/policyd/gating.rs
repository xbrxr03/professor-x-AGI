/// JARVIS policyd gate — every tool call passes through here.
///
/// Risk scores and URL validation ported from ClawOS policyd/service.py.
/// Merkle audit trail added here (ClawOS doesn't actually implement it).
/// Approval timeout: 300s (vs ClawOS's 5s — useless for overnight autonomous runs).
